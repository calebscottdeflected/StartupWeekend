...
class ViewController: UIViewController {
    ...
    @IBAction func The27(){
        ...
        UIView.animate(withDuration: 1.0, animations: { () -> Void in
            ...
            self.Oct27?.backgroundColor = UIColor(red: 255/255, green: 244/255, blue: 132/255, alpha: 1)
        })
    }
    @IBAction func The3(){
        Take?.isHidden = false
        UIView.animate(withDuration: 1.0, animations: { () -> Void in
            ...
            self.Oct3?.backgroundColor = UIColor(red: 255/255, green: 244/255, blue: 132/255, alpha: 1)
